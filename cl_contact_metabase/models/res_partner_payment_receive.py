...
class ResPartner(models.Model):
    ...
    def _sync_payment_received(self):
        ...
        try:
            ...
            # Get payment received data from Metabase (using config method with max_results support)
            _logger.info("Fetching payment received details from Metabase...")
            data = config.get_payment_received()
            ...
            for batch_num in range(total_batches):
                ...
                for payment_data in batch_data:
                    try:
                        ...
                        _logger.warning(f"Error processing payment received for invoice {invoice_id}: {str(e)}")
                        batch_skipped += 1
                        continue
            ...
            _logger.info(
                f"Payment received sync completed successfully. Created: {created_count}, "
