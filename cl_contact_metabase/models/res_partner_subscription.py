...
class ResPartner(models.Model):
    ...
    def _sync_student_subscriptions(self):
        ...
        try:
            ...
            # Get subscription data from Metabase (using config method with max_results support)
            _logger.info("Fetching subscription details from Metabase...")
            data = config.get_subscription_data()
            ...
            for batch_num in range(total_batches):
                ...
                for subscription_data in batch_data:
                    try:
                        ...
                        _logger.warning(f"Error processing subscription {subscription_id}: {str(e)}")
                        batch_skipped += 1
                        continue
            ...
            _logger.info(
                f"Subscription sync completed successfully. Created: {created_count}, "
